        ...
        >
          ...
          <el-dropdown class="user-name el-menu-item" @command="selectlanguage" :show-timeout="0">
            <span class="el-dropdown-link">
              <img style="width: 30px;" :src="'/static/images/language/'+selected+'.png'" alt />
...
export default {
  data() {
    return {
      ...
      logo: "/static/logo/tx.png",
      language: [
        {
          title: "中文简体",
          index: "zh",
          url: "/static/images/language/zh.png"
        },
        {
          title: "English",
          index: "en",
          url: "/static/images/language/en.png"
        }
      ],
