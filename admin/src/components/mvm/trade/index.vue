<template>
  <div class="PaymentRecords">
    ...
    <div class="container">
        ...
        <el-row :gutter="15" style="margin-top: 15px">
          <el-col :md="6" :sm="12" :xs="24">
            <el-card class="box-card" shadow="hover">
              ...
              <div class="text item">
                <p>
                  <el-tag>{{sumData | getDictValue('buyVolume')}}</el-tag>
                </p>
              </div>
            </el-card>
          </el-col>
          <el-col :md="6" :sm="12" :xs="24">
            <el-card class="box-card" shadow="hover">
              ...
              <div class="text item">
                <p>
                  <el-tag>{{sumData | getDictValue('buyAmount')}}</el-tag>
                </p>
              </div>
            </el-card>
          </el-col>
          <el-col :md="6" :sm="12" :xs="24">
            <el-card class="box-card" shadow="hover">
              ...
              <div class="text item">
                <p>
                  <el-tag>{{sumData | getDictValue('sellVolume')}}</el-tag>
                </p>
              </div>
            </el-card>
          </el-col>
          <el-col :md="6" :sm="12" :xs="24">
            <el-card class="box-card" shadow="hover">
              ...
              <div class="text item">
                <p>
                  <el-tag>{{sumData | getDictValue('sellAmount')}}</el-tag>
                </p>
              </div>
            </el-card>
          </el-col>
      ...
      >
        <el-table-column prop="bidUid" label="买方账户">
          <template slot-scope="scope">
            <el-popover
              ...
              @show="currentUserInfo(scope.row.bidUid)"
            >
              ...
              <el-tag slot="reference">{{scope.row | getDictValue('bidUid')}}</el-tag>
            </el-popover>
          </template>
        </el-table-column>
        <el-table-column prop="askUid" label="卖方账户">
          <template slot-scope="scope">
            <el-popover
              placement="top-start"
              width="200"
              trigger="hover"
              @hide="userInfo = {loading:true}"
              @show="currentUserInfo(scope.row.askUid)"
            >
              <div v-loading="userInfo.loading">
                <p>真实姓名：{{userInfo |getDictValue('truename')}}</p>
                <p>手机号：{{userInfo |getDictValue('mobile')}}</p>
              ...
              <el-tag slot="reference">{{scope.row | getDictValue('askUid')}}</el-tag>
            </el-popover>
          </template>
        </el-table-column>
        ...
        <!-- <el-table-column label="成交量" prop="" align="center">
...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      this.loading = true;
      try {
        let result = await mvmApi.tradeStat({
