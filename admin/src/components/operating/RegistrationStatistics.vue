    ...
    <div class="info">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>注册统计</el-breadcrumb-item>
            </el-breadcrumb>
        ...
        <div class="container">
            ...
            <el-table :data="resultList" border class="table" v-loading="loading" ref="multipleTable"
                ...
                <el-table-column label="绑定手机人数">
                    <template slot-scope="scope">

                    </template>
                </el-table-column>

                <el-table-column label="绑定邮箱人数" align="center">
                    <template slot-scope="scope">

                    </template>
                </el-table-column>
                <el-table-column label="设置资金密码人数"  align="center">
                    <template slot-scope="scope">

                    </template>
                </el-table-column>
                <el-table-column label="完成充值人数" align="center">
                    <template slot-scope="scope">
